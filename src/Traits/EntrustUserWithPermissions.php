...
trait EntrustUserWithPermissions
{
    ...
    {
        return $this->belongsToMany(Config::get('laratrust.permission'), Config::get('laratrust.permission_user_table'), 'user_id', 'permission_id');
    }
    ...
    public function can($permission, $requireAll = false)
    {
        ...
        // User permission not granted, check roles via laratrust
    ...
    {
        return $this->belongsToMany(config('laratrust.permission'));
    }
